...
<div class="col-lg-12 mt-4 mb-4">
    <button class="btn btn-secondary btn-block mt-2" type="button" data-toggle="collapse" data-target="#filters" aria-expanded="false"
        aria-controls="collapseExample">
        Zoeken
    </button>
    <form method="POST" action="/products/search/">
        @csrf @if(isset($cat_id))
        <input type="hidden" name="cat_id" value="{{$cat_id}}"> @endif
